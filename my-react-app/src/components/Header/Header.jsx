  ...
  return (
    <div className='header'>
      <div className="header-contents">
        ...
        <p className="text-red-700 font-bold text-xl font-cute">Choose from a diverse menu feauring a delectable array of dishes crafetd with the finest ingredients and culinary expertise
